...
SearchBox.send_keys("Ribble R872 Disc Teal")
SearchBox.submit()

t = driver.find_element(By.PARTIAL_LINK_TEXT, "Ribble R872 Disc Teal").text # assert product
if t.__contains__('Ribble R872 Disc'):
    print(t)
else:
    print('error')
driver.quit()
